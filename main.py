...
def build_app() -> Application:
    ...
    addwindow_conv = ConversationHandler(
        entry_points=[CommandHandler("addwindow", windows.addwindow_start)],
        states={
            windows.CHOOSE_CHAT: [CallbackQueryHandler(windows.addwindow_choose_chat, pattern=r"^aw_chat:")],
            windows.ENTER_START: [MessageHandler(filters.TEXT & ~filters.COMMAND, windows.addwindow_enter_start)],
            windows.ENTER_END: [MessageHandler(filters.TEXT & ~filters.COMMAND, windows.addwindow_enter_end)],
            windows.ENTER_INTERVAL: [MessageHandler(filters.TEXT & ~filters.COMMAND, windows.addwindow_enter_interval)],
        },
